...
| Crypto Web Scraper     | This project scrapes cryptocurrency data using Python or R.            | [Repo Link](https://github.com/benlug/crypto-web-scraper/tree/main)                         | Web scraping, Data extraction, R, Python            |
